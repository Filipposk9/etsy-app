...
const SignUpModal = ({ onHideLoginModal, onLoginSuccess }) => {
    ...
    const onSubmit = (0, react_1.useCallback)((credentials) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const newUser = yield SignUpApi.login(credentials);
