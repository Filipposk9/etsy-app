...
const getData = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const response = yield axios_1.default.get(`https://api.etsy.com/v3/application/shops/${validateEnv_1.default.ETSY_SHOP_ID}/receipts?was_shipped=false&sort_on=created&sort_order=asc&limit=75`, {
            headers: {
